...
INSERT INTO users (id, username, password, email, is_enable, account_no_expired, account_no_locked, credentials_no_expired) VALUES
  ('750e8400-e29b-41d4-a716-446655440006', 'adminUser', 'hashed_password_1', 'admin@example.com', true, true, true, true),
  ('750e8400-e29b-41d4-a716-446655440007', 'normalUser', 'hashed_password_2', 'user@example.com', true, true, true, true);
